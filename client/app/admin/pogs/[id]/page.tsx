...
const formSchema = z.object({
  ...
  currentPrice: z.string().refine((value) => parseInt(value) > 0),
  color: z.string(),
  ...
  //   return { r, g, b };
  // }),
  ticker: z.string().toUpperCase().max(5),
});

export default function PogsID() {
    ...
    <Card className="w-96 p-4">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          ...
          <Button className="mt-8" type="submit">Save Edits</Button>
        </form>
      </Form>
    </Card>
  </div>
